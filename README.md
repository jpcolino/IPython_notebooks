...
- **NEW:** [Neural Networks (RNN/LSTM/GRU) for time-series in Commodities Markets using TensorFlow/Keras](https://github.com/jpcolino/IPython_notebooks/blob/master/RNN_LSTM_GRU_for_Hedge_Funds%20_flows.ipynb) (here, just the simplest of the univariate versions. If you are inteterested in the deep multivariate version, contact me)
