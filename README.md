...
- [**Doing Statistics with Python**](https://github.com/jpcolino/IPython_notebooks/blob/master/Doing%20Statistics%20with%20Python.ipynb): *(Statisitics and Machine Learning)* Another huge notebook, in fact, I wrote it thinking in a free eBook, but it is quite general (and basic) in terms of statistics.  
  - If you look for some more advanced statistics, but always with Python implementations, have a look to the notebooks of [Volatility Forecasting](https://github.com/jpcolino/IPython_notebooks/blob/master/Time-Series%20Analysis%20and%20Volatility%20Forecast.ipynb), [Outliers detection](https://github.com/jpcolino/IPython_notebooks/blob/master/Multivariate%20Outliers.ipynb) for multivariate datasets, [K-means without Scikit](https://github.com/jpcolino/IPython_notebooks/blob/master/K-Means%20without%20Scikit-Learn.ipynb) or [EM-Algorithm](https://github.com/jpcolino/IPython_notebooks/blob/master/EM_Algorithm.ipynb) for clustering and missing values
  - If you want to go deeper in **Statistics Techniques for Big (distributed) Data**, maybe you should have a look into the [**PCA for Big Data**](https://github.com/jpcolino/IPython_notebooks/blob/master/PCA%20with%20BigData.ipynb) or into [**Regression Techniques for Big Data**](https://github.com/jpcolino/IPython_notebooks/blob/master/Regression%20Techniques%20with%20BigData.ipynb) notebooks, where I am using **Apache Spark** with **PySpark**. 
  - If you are working in **Machine Learning and Deep Learning**, have a look into one of the Support Vector Machines (SVM) notebooks (e.g. [Cross Validation in SVM](https://github.com/jpcolino/IPython_notebooks/blob/master/Cross-Validation%20in%20SVM.ipynb), or [Classification Metrics with SVM](https://github.com/jpcolino/IPython_notebooks/blob/master/Classification%20Metrics%20with%20SVM.ipynb)), and more specifically into **Deep Learning** in [Generative Models: Autoencoders, VANs and GANs notebook](https://github.com/jpcolino/IPython_notebooks/blob/master/Generative_Models_Autoencoders_and_GANs.ipynb) with **TensorFlow** and **Keras**.
